<template>
  <div>
    <h1>= hi!</h1>
    <p>welcome to my website! my name is kuvii and i'm a tech nerd.</p>
    <p>i mostly make cool shit in my free time and play video games.</p>
    <p>
      i haven't yet done any work to make this webpage responsive, sorry about that :p i'll probably rewrite this at
      least a thousand times because i'm never too satisfied with my work.
    </p>
  </div>
  ...
  <div>
    <h2>== gpg pubkey</h2>
    <code title="key fingerprint"><a href="/kuvii_pub.gpg">72CD CA63 A72A 12C7 2869 5D41 F3C8 9268 D3B0 E486</a></code>
  </div>
